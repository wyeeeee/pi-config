/**
 * btw.ts — vendored from pi-btw (https://github.com/dbachelder/pi-btw).
 * Copyright (c) 2026 Dan Bachelder — MIT License (see repo attribution).
 * Vendored at v0.4.1 (upstream commit 4f85810); maintained locally here.
 * Provides the /btw parallel side-conversation channel (real pi sub-session
 * with read/bash/edit/write, modal overlay, /btw:inject|summarize handoff).
 */
import {
  buildSessionContext,
  createAgentSession,
